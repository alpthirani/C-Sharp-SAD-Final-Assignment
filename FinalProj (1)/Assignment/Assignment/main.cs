    ...
    public partial class main : Form
    {
        ...
        private void gunaButton2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                    ...
                    Con.Open();
                    string query = "update BOOKTable set Btitle ='" + Btitletxt.Text + "',Bauthor='" + Bauthortxt.Text + "',Bcatagories='" + Bcategoriescm.SelectedItem.ToString() + "',Bquantity=" + Bqtytxt.Text + ",Bprice=" + Bpricetxt.Text + " where BId=" + key + ";";
                    SqlCommand cmd = new SqlCommand(query, Con);
                    cmd.ExecuteNonQuery();
        ...
        {
            Con.Open();
            string query = "select * from BOOKTable where Bcatagories='" + BsearchCmb.SelectedItem.ToString()+"'";
            SqlDataAdapter sda = new SqlDataAdapter(query, Con);
            SqlCommandBuilder builder = new SqlCommandBuilder(sda);
            var ds = new DataSet();
            sda.Fill(ds);
        ...
        private void gunaButton1_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                string query = "insert into BOOKTable values('" + Btitletxt.Text + "','" + Bauthortxt.Text + "','" + Bcategoriescm.SelectedItem.ToString() + "'," + Bqtytxt.Text + "," + Bpricetxt.Text + ")";
                 SqlCommand cmd = new SqlCommand(query, Con);
                cmd.ExecuteNonQuery();
