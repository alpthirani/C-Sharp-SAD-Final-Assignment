...
namespace Assignment
{
    public partial class user : Form
    {
        ...
        private void gunaButton1_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                string query = "insert into UserTbl values('" + Usertxt.Text + "','" + Phonetxt.Text + "','" +Addtxt.Text+ "','"+Passtxt.Text+"')";
        ...
        private void Editbtn_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                string query = "update UserTbl set UName='" + Usertxt.Text + "',UPhone='" + Phonetxt.Text + "',UAddress='" + Addtxt.Text + "',UPass='" + Passtxt.Text + "' where UId=" + key + ";";
                SqlCommand cmd = new SqlCommand(query, Con);
                cmd.ExecuteNonQuery();
